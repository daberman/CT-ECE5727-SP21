...
(* CORE_GENERATION_INFO="invert,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=13.500000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.573250,HLS_SYN_LAT=926643,HLS_SYN_TPT=926644,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=405,HLS_SYN_LUT=1445}" *)
...
wire    SubRS_U0_ap_start;
wire    SubRS_U0_ap_done;
wire    SubRS_U0_ap_continue;
wire    SubRS_U0_ap_idle;
wire    SubRS_U0_ap_ready;
wire    SubRS_U0_start_out;
wire    SubRS_U0_start_write;
wire    SubRS_U0_src_data_stream_0_V_read;
wire    SubRS_U0_src_data_stream_1_V_read;
wire    SubRS_U0_src_data_stream_2_V_read;
wire   [7:0] SubRS_U0_dst_data_stream_0_V_din;
wire    SubRS_U0_dst_data_stream_0_V_write;
wire   [7:0] SubRS_U0_dst_data_stream_1_V_din;
wire    SubRS_U0_dst_data_stream_1_V_write;
wire   [7:0] SubRS_U0_dst_data_stream_2_V_din;
wire    SubRS_U0_dst_data_stream_2_V_write;
...
wire    ap_sync_done;
wire    ap_sync_ready;
wire   [0:0] start_for_SubRS_U0_din;
wire    start_for_SubRS_U0_full_n;
wire   [0:0] start_for_SubRS_U0_dout;
wire    start_for_SubRS_U0_empty_n;
...
start_for_SubRS_U0 start_for_SubRS_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign SubRS_U0_ap_continue = 1'b1;

assign SubRS_U0_ap_start = start_for_SubRS_U0_empty_n;

assign ap_done = Mat2AXIvideo_U0_ap_done;

assign ap_idle = (SubRS_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign start_for_SubRS_U0_din = 1'b1;
