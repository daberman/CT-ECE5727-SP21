...
architecture behav of invert is 
    ...
    "invert,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=13.500000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.573250,HLS_SYN_LAT=926643,HLS_SYN_TPT=926644,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=405,HLS_SYN_LUT=1445}";
    ...
    signal SubRS_U0_ap_start : STD_LOGIC;
    signal SubRS_U0_ap_done : STD_LOGIC;
    signal SubRS_U0_ap_continue : STD_LOGIC;
    signal SubRS_U0_ap_idle : STD_LOGIC;
    signal SubRS_U0_ap_ready : STD_LOGIC;
    signal SubRS_U0_start_out : STD_LOGIC;
    signal SubRS_U0_start_write : STD_LOGIC;
    signal SubRS_U0_src_data_stream_0_V_read : STD_LOGIC;
    signal SubRS_U0_src_data_stream_1_V_read : STD_LOGIC;
    signal SubRS_U0_src_data_stream_2_V_read : STD_LOGIC;
    signal SubRS_U0_dst_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal SubRS_U0_dst_data_stream_0_V_write : STD_LOGIC;
    signal SubRS_U0_dst_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal SubRS_U0_dst_data_stream_1_V_write : STD_LOGIC;
    signal SubRS_U0_dst_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal SubRS_U0_dst_data_stream_2_V_write : STD_LOGIC;
    ...
    signal start_for_SubRS_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_SubRS_U0_full_n : STD_LOGIC;
    signal start_for_SubRS_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_SubRS_U0_empty_n : STD_LOGIC;
    ...
    component start_for_SubRS_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        start_full_n => start_for_SubRS_U0_full_n,
    ...
    SubRS_U0 : component SubRS
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => SubRS_U0_ap_start,
        start_full_n => start_for_Mat2AXIvideo_U0_full_n,
        ap_done => SubRS_U0_ap_done,
        ap_continue => SubRS_U0_ap_continue,
        ap_idle => SubRS_U0_ap_idle,
        ap_ready => SubRS_U0_ap_ready,
        start_out => SubRS_U0_start_out,
        start_write => SubRS_U0_start_write,
        src_data_stream_0_V_dout => img0_data_stream_0_s_dout,
        src_data_stream_0_V_empty_n => img0_data_stream_0_s_empty_n,
        src_data_stream_0_V_read => SubRS_U0_src_data_stream_0_V_read,
        src_data_stream_1_V_dout => img0_data_stream_1_s_dout,
        src_data_stream_1_V_empty_n => img0_data_stream_1_s_empty_n,
        src_data_stream_1_V_read => SubRS_U0_src_data_stream_1_V_read,
        src_data_stream_2_V_dout => img0_data_stream_2_s_dout,
        src_data_stream_2_V_empty_n => img0_data_stream_2_s_empty_n,
        src_data_stream_2_V_read => SubRS_U0_src_data_stream_2_V_read,
        dst_data_stream_0_V_din => SubRS_U0_dst_data_stream_0_V_din,
        dst_data_stream_0_V_full_n => img1_data_stream_0_s_full_n,
        dst_data_stream_0_V_write => SubRS_U0_dst_data_stream_0_V_write,
        dst_data_stream_1_V_din => SubRS_U0_dst_data_stream_1_V_din,
        dst_data_stream_1_V_full_n => img1_data_stream_1_s_full_n,
        dst_data_stream_1_V_write => SubRS_U0_dst_data_stream_1_V_write,
        dst_data_stream_2_V_din => SubRS_U0_dst_data_stream_2_V_din,
        dst_data_stream_2_V_full_n => img1_data_stream_2_s_full_n,
        dst_data_stream_2_V_write => SubRS_U0_dst_data_stream_2_V_write);
    ...
    port map (
        ...
        if_read => SubRS_U0_src_data_stream_0_V_read);
    ...
    port map (
        ...
        if_read => SubRS_U0_src_data_stream_1_V_read);
    ...
    port map (
        ...
        if_read => SubRS_U0_src_data_stream_2_V_read);
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => SubRS_U0_dst_data_stream_0_V_din,
        if_full_n => img1_data_stream_0_s_full_n,
        if_write => SubRS_U0_dst_data_stream_0_V_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => SubRS_U0_dst_data_stream_1_V_din,
        if_full_n => img1_data_stream_1_s_full_n,
        if_write => SubRS_U0_dst_data_stream_1_V_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => SubRS_U0_dst_data_stream_2_V_din,
        if_full_n => img1_data_stream_2_s_full_n,
        if_write => SubRS_U0_dst_data_stream_2_V_write,
        if_dout => img1_data_stream_2_s_dout,
        if_empty_n => img1_data_stream_2_s_empty_n,
        if_read => Mat2AXIvideo_U0_img_data_stream_2_V_read);

    start_for_SubRS_U0_U : component start_for_SubRS_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_SubRS_U0_din,
        if_full_n => start_for_SubRS_U0_full_n,
        if_write => AXIvideo2Mat_U0_start_write,
        if_dout => start_for_SubRS_U0_dout,
        if_empty_n => start_for_SubRS_U0_empty_n,
        if_read => SubRS_U0_ap_ready);
    ...
    SubRS_U0_ap_continue <= ap_const_logic_1;
    SubRS_U0_ap_start <= start_for_SubRS_U0_empty_n;
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (SubRS_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ap_ready <= AXIvideo2Mat_U0_ap_ready;
    ...
    start_for_SubRS_U0_din <= (0=>ap_const_logic_1, others=>'-');
    stream_in_TREADY <= AXIvideo2Mat_U0_stream_in_TREADY;
    stream_out_TDATA <= Mat2AXIvideo_U0_stream_out_TDATA;
    stream_out_TDEST <= Mat2AXIvideo_U0_stream_out_TDEST;
    stream_out_TID <= Mat2AXIvideo_U0_stream_out_TID;
